...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-[url('/src/assets/download.jpg')] bg-cover items-center">
      {/* Header */}
      <div className="flex justify-between items-center mt-8 pl-5 pb-5 bg-zinc-700 rounded-lg w-350 h-16">
        <div>
      ...
      {/* Balance Card */}
      <div className="w-350 h-30 bg-zinc-700 mt-10 rounded-lg">
        <div className="text-white text-4xl pl-5 pt-5">Your Balance</div>
        <div className="text-white text-2xl pl-5 pt-2">$ 10000</div>
      </div>

      {/* Search Bar */}
      <div className="flex justify-start items-center mt-10 w-350 h-12 bg-zinc-700 rounded-lg">
        <svg
